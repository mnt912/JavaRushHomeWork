...
public class Solution
{
    ...
    {
        if (s.startsWith("0x"))
            return Integer.valueOf(Integer.parseInt(s.substring(2), 16)).toString();

        if (s.startsWith("0b"))
            return Integer.valueOf(Integer.parseInt(s.substring(2), 2)).toString();

        if (s.startsWith("0"))
            return Integer.valueOf(Integer.parseInt(s.substring(1), 8)).toString();
