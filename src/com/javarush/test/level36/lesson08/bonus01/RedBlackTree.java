...
public class RedBlackTree {
    ...
    private Node rotate(int item, Node parent) {
        if (item < parent.element) {
            parent.left = item < parent.left.element ?
                    rotateWithLeftNode(parent.left) :
                    rotateWithRightNode(parent.left);
            return parent.left;
        }
        else {
            parent.right = item < parent.right.element ?
                    rotateWithLeftNode(parent.right) :
                    rotateWithRightNode(parent.right);
            return parent.right;
        }
    }
