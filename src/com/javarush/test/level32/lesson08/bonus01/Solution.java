...
public class Solution {
    ...
    public <T extends Item> T getProxy(Class<T> a, Class... interfaces) {
        Class[] interfaces1 = new Class[interfaces.length + 1];
        System.arraycopy(interfaces, 0, interfaces1, 0, interfaces.length);
        interfaces1[interfaces1.length-1] = a;
        ItemInvocationHandler handler = new ItemInvocationHandler();
        return  (T) Proxy.newProxyInstance(a.getClassLoader(), interfaces1, handler);
    }
}
