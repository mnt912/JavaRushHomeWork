...
public class Solution {
    ...
    public static boolean isAllModifiersContainSpecificModifier(int allModifiers, int specificModifier) {
        switch(specificModifier) {
            case 1: return Modifier.isPublic(allModifiers);
            case 2: return Modifier.isPrivate(allModifiers);
            case 4: return Modifier.isProtected(allModifiers);
            case 8: return Modifier.isStatic(allModifiers);
            case 16: return Modifier.isFinal(allModifiers);
            case 32: return Modifier.isSynchronized(allModifiers);
            case 64: return Modifier.isVolatile(allModifiers);
            case 128: return Modifier.isTransient(allModifiers);
            case 256: return Modifier.isNative(allModifiers);
            case 512: return Modifier.isInterface(allModifiers);
            case 1024: return Modifier.isAbstract(allModifiers);
            case 2048: return Modifier.isStrict(allModifiers);
